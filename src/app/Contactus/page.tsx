...
export default function ContactUs() {
  return (
    <div className="w-full">
      ...
      {/* Contact Info */}
      <div className=" flex flex-col lg:flex-row justify-center lg:justify-start items-center lg:items-start pt-[40px] px-4 lg:px-[190px]">
        <div className="space-y-6 lg:w-[60%] pl-[20px]">
          <div className="flex items-center space-x-4 pt-[30px] ">
        ...
        {/* Contact Form */}
        <div className="lg:w-[35%] bg-white pl-4  py-6 mt-8 lg:mt-0 w-full max-w-[450px]">
